...
jQuery(document).ready(function(){	
  ...
  id = id+'/ajaxload';
	...
	if(jQuery('.blogpost').is(":visible")){
		...
		jQuery('.showpostpostcontent').load(id  ,function () {
		...
		if (jQuery('.posttext img').length > 0){
		...
		jQuery('.posttext img').imagesLoaded(function () {
			...
			jQuery('.showpostpostcontent').delay(1000).fadeIn(200);
			jQuery('.closehomeshow').delay(1000).fadeIn(200);
	...
	jQuery('.closehomeshow').click(function() {
		...
		jQuery('.showpostpostcontent').fadeOut(200);
		jQuery('.closehomeshow').fadeOut(200);	
		jQuery('#showpost').animate({"height": "-="+height+"px"}, 750,function(){jQuery('#showpost').animate({"margin-top": "+=30px"}, 500,function(){jQuery('#remove').fadeIn(200);});});
