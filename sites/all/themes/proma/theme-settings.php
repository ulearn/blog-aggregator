...
function _proma_get_css($color_code, $theme_background) {
  ...
  $output = 'a, .color_3, .color_green, .sf-menu > li > a:hover, .sf-menu > li.current > a, .sf-menu > li.sfHover > a, .sf-menu li li a:hover, .sf-menu li.sfHover li.sfHover > a, ul.list-box .price-text .price, .posttime h1, .smalldate, .posttitle a:hover, .caption.big_green, .caption.very_big_green{color: #' . $color_code . ' !important;}';
